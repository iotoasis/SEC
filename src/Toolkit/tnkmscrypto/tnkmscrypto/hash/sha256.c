...
/*	
	Name : sha256_process
	Description: 64바이트 데이터에 대해서 해시계산을 수행한다.
	Parameters
	[in/out] ctx : 해시계산값이 저장되는 컨텍스트 구조체
	[in] data : 해시를 수행할 대상 데이터
	Return Value : 
	Note : 
*/
void sha256_process( SHA256_CTX *ctx, U8 data[64] )
{
