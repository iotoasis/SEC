...
#include <time.h>
#include <windows.h>
#include <BoardLib/ioctls.h>
#include <BoardLib/dispatch.h>
#include <BoardLib/ubsec.h>
#include <BoardLib/ubsec_lib.h>
#include <initguid.h>
#include <BoardLib/guids.h>
...
SRESULT SCRT_EncryptFinal_MAC(SCRT_CIPHER_CTX *ctx, unsigned char *out, int *outl)
{
	...
	E_SR = S_FAILED | SL_BLOCK | SF_SCRT_ENCRYPT_FINAL_MAC;
	b=ctx->cipher->block_size;
