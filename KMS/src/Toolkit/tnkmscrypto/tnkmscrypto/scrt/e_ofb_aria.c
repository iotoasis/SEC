...
static SCRT_CIPHER d_ofb128_128_aria=
{
	...
	16, /* key length */
	16, /* iv length */
	S_aria_ofb128_128_init_key, /* iv, key setting 함수 */
	S_aria_ofb128_cipher,   /* 암복호화 함수 */
	NULL,				   /* 마무리 함수 */
...
static SCRT_CIPHER d_ofb128_192_aria=
{
	...
	24, /* key length */
	16, /* iv length */
	S_aria_ofb128_192_init_key, /* iv, key setting 함수 */
	S_aria_ofb128_cipher,   /* 암복호화 함수 */
	NULL,				   /* 마무리 함수 */
	sizeof(SCRT_CIPHER_CTX)-sizeof((((SCRT_CIPHER_CTX *)NULL)->c))+ /* structure size */
		sizeof((((SCRT_CIPHER_CTX *)NULL)->c.aria_ks))
...
static SCRT_CIPHER d_ofb128_256_aria=
{
	...
	32, /* key length */
	16, /* iv length */
	S_aria_ofb128_256_init_key, /* iv, key setting 함수 */
	S_aria_ofb128_cipher,   /* 암복호화 함수 */
	NULL,				   /* 마무리 함수 */
	sizeof(SCRT_CIPHER_CTX)-sizeof((((SCRT_CIPHER_CTX *)NULL)->c))+ /* structure size */
		sizeof((((SCRT_CIPHER_CTX *)NULL)->c.aria_ks))
...
/*
	Name : SCRT_aria_128_ofb128
 	...
 	Parameters
 	Return Value : d_ofb128_128_aria 구조체를 반환한다
 	Note :
 */
...
/*
	Name : SCRT_aria_192_ofb128
 	...
 	Parameters
 	Return Value : d_ofb128_192_aria 구조체를 반환한다.
 	Note :
 */
...
/*
	Name : SCRT_aria_256_ofb128
 	...
 	Parameters
 	Return Value : d_ofb128_256_aria 구조체를 반환한다.
 	Note :
 */
...
/*
	Name : S_aria_ofb128_128_init_key
 	Description : 암호키를 이용하여 ARIA 128bit OFB모드 암호 알고리즘에 필요한 키 구조체 및 알고리즘 정보를 설정한다.
 	Parameters
...
/*
	...
	Description : 암호키를 이용하여 ARIA 192bit OFB모드 암호 알고리즘에 필요한 키 구조체 및 알고리즘 정보를 설정한다.
	Parameters
	[out] ctx : ARIA 암/복호화를 위한 ARIA_KEY 키 구조체 및 정보를 담은 구조체
	[in] key : 암호키 데이터
	[in] iv : 초기화 벡터
...
/*
	...
	Description : 암호키를 이용하여 ARIA 256bit OFB모드 암호 알고리즘에 필요한 키 구조체 및 알고리즘 정보를 설정한다.
	Parameters
	[out] ctx : ARIA 암/복호화를 위한 ARIA_KEY 키 구조체 및 정보를 담은 구조체
	[in] key : 암호키 데이터
	[in] iv : 초기벡터
...
/*
	...
	Description : 설정된 암호키 및 초기벡터와 ARIA OFB 모드 암호 알고리즘을 이용하여 암/복호화 한다.
	Parameters
